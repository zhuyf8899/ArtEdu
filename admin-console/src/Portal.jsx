  ...
  return <div className="portal-shell" data-section={section}>
    ...
    <main className={`portal-main ${section === "home" ? "portal-main--home" : ""}`}>
      ...
      <Suspense fallback={<section className="portal-empty"><p>正在加载页面…</p></section>}>
        ...
        {section === "studio" && <WorkflowStudio initialWorkflowId={studioWorkflowId} onNotice={showToast} canManageToolDirectory={account.roles?.includes("admin")} canPublish={account.roles?.some((role) => ["admin", "teacher", "operator"].includes(role))} />}
