INSERT OR IGNORE INTO roles (id, name, description) VALUES
  ...
  ('role-student', 'student', '学习课程并发布作品的学生');

INSERT OR IGNORE INTO departments (id, code, name) VALUES
  ('dept-project', 'PROJECT', '项目组'),
  ('dept-fine-arts', 'FINE_ARTS', '美术学院');

INSERT OR IGNORE INTO users (id, username, display_name, email, department_id) VALUES
  ...
  ('user-student-demo', 'student.demo', '演示学生', 'student.demo@example.edu', 'dept-fine-arts');

INSERT OR IGNORE INTO user_roles (user_id, role_id) VALUES
  ('user-admin-demo', 'role-admin'),
  ('user-operator-demo', 'role-operator'),
  ('user-teacher-demo', 'role-teacher'),
  ('user-student-demo', 'role-student');

INSERT OR IGNORE INTO courses
  (id, title, summary, category, difficulty, is_featured, featured_rank, status, created_by)
VALUES
  ('course-ai-design-foundation', 'AI 辅助设计思维与方法', '从灵感到方案，理解 AI 在设计流程中的作用。', '设计基础', 'beginner', 1, 1, 'published', 'user-teacher-demo'),
  ('course-traditional-pattern', '传统纹样的当代表达', '从传统视觉元素中提取结构并完成现代转译。', '视觉设计', 'intermediate', 0, NULL, 'published', 'user-teacher-demo');
...
VALUES
  ...
  ('workflow-image-draft', '图片生成工作流', '从文字描述开始生成可继续讨论的视觉草稿。', '视觉生成', 'workbench', '/#generate', 'published', 'user-teacher-demo');
...
VALUES
  ('workflow-case-analysis-v1', 'workflow-case-analysis', 1, '{"steps":["observe","analyze","reflect"]}', '请从设计目标、视觉结构和创作方法分析这个案例。', CURRENT_TIMESTAMP, 'user-teacher-demo');

INSERT OR IGNORE INTO tools
  (id, name, description, category, tool_type, entry_url, status, created_by)
VALUES
  ('tool-font-lab', '字体搭配实验室', '用于测试字体组合与品牌气质。', '字体设计', 'internal', '/tools/font-lab', 'published', 'user-teacher-demo');

INSERT OR IGNORE INTO workflow_tools (workflow_id, tool_id) VALUES
  ('workflow-case-analysis', 'tool-font-lab');

INSERT OR IGNORE INTO model_providers (id, name, provider_type) VALUES
  ('provider-school', '清华艺智模型服务', 'school');

INSERT OR IGNORE INTO model_configs
  (id, provider_id, display_name, model_identifier, capabilities_json, secret_ref)
VALUES
  ('model-school-chat', 'provider-school', '清华艺智教学对话模型', 'thu-art-chat-v1', '["chat","teaching"]', 'secrets/thu-art-chat-v1');

INSERT OR IGNORE INTO works
  (id, author_id, title, summary, discipline, is_featured, featured_rank, status, published_at)
VALUES
  ('work-demo-cloud-pattern', 'user-student-demo', '云格新序：传统纹样的当代表达', '从云纹、格栅与植物轮廓中提取结构特征，重新组织为当代视觉系统。', '视觉系统设计', 1, 1, 'approved', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO work_workflows (work_id, workflow_id) VALUES
  ('work-demo-cloud-pattern', 'workflow-case-analysis');

INSERT OR IGNORE INTO tags (id, name, slug) VALUES
  ('tag-traditional-pattern', '传统纹样', 'traditional-pattern'),
  ('tag-ai-design', 'AI 设计', 'ai-design');

INSERT OR IGNORE INTO books
  (id, title, authors, publisher, summary, external_url, is_featured, featured_rank, status)
VALUES
  ('book-designing-with-ai', '设计中的人工智能', '演示作者', '演示出版社', '面向设计学习者的 AI 方法参考书。', 'https://example.edu/books/designing-with-ai', 1, 1, 'published');

INSERT OR IGNORE INTO book_tags (book_id, tag_id) VALUES
  ('book-designing-with-ai', 'tag-ai-design');

INSERT OR IGNORE INTO work_tags (work_id, tag_id) VALUES
  ('work-demo-cloud-pattern', 'tag-traditional-pattern'),
  ('work-demo-cloud-pattern', 'tag-ai-design');

INSERT OR IGNORE INTO comments (id, work_id, author_id, content) VALUES
  ('comment-demo-01', 'work-demo-cloud-pattern', 'user-teacher-demo', '结构提取很清晰，可以继续补充色彩系统的推导过程。');

INSERT OR IGNORE INTO work_likes (work_id, user_id) VALUES
  ('work-demo-cloud-pattern', 'user-teacher-demo');

INSERT OR IGNORE INTO work_favorites (work_id, user_id) VALUES
  ('work-demo-cloud-pattern', 'user-student-demo');

INSERT OR IGNORE INTO conversations
  (id, user_id, course_id, conversation_type, title)
VALUES
  ('conversation-demo-01', 'user-student-demo', 'course-ai-design-foundation', 'teaching', '生成式 AI 学习讨论');

INSERT OR IGNORE INTO conversation_messages
  (id, conversation_id, sender_type, content, model_config_id)
VALUES
  ('message-demo-01', 'conversation-demo-01', 'user', '什么是生成式 AI？', NULL),
  ('message-demo-02', 'conversation-demo-01', 'assistant', '它根据输入内容生成新的文本、图像或其他媒体。', 'model-school-chat');

INSERT OR IGNORE INTO user_usage_limits
  (id, user_id, capability, period_type, limit_value)
VALUES
  ('limit-demo-image-daily', 'user-student-demo', 'image_generation', 'daily', 20);

INSERT OR IGNORE INTO usage_records
  (id, user_id, model_config_id, capability, request_id, input_units, output_units, status)
VALUES
  ('usage-demo-01', 'user-student-demo', 'model-school-chat', 'teaching_chat', 'req-demo-01', 120, 180, 'success');
