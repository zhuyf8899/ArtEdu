...
export const updateCourseResource = (courseId, resourceId, metadata) => request(
  `/admin/courses/${encodeURIComponent(courseId)}/resources/${encodeURIComponent(resourceId)}`,
